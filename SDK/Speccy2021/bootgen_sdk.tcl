...
set file [open "$project_name/src/version.c"]
...
if { $build_config == "release" || $build_config == "all" } {
    exec bootgen -image bootimage/${project_name}.bif -arch zynq -o bootimage/${project_name}_${version_string}.bin -w on -p xc7z020 
}

if { $build_config == "debug" || $build_config == "all" } {
    exec bootgen -image bootimage/${project_name}_debug.bif -arch zynq -o bootimage/${project_name}_${version_string}_debug.bin -w on -p xc7z020  -log info
}
